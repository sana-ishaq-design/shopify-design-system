...
|-----------|--------|-------|----------------|-------|----------|
| Color Tokens (Primary, Secondary, Neutral, Success, Error) | ✅ | Add semantic naming + WCAG contrast check | [Link]((https://www.figma.com/design/RI8epkmOBGRdvyYbxlgDJH/Shopify-Figma-Design-System?node-id=8-337&t=9kRJjsre3iBJOAnE-1)) | e.g., home | High |
